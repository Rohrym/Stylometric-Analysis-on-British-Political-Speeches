...
print("\033[1mChi-squared values of Churchill's speeches before and after World War II\033[0m")
print(table)
...
# 
# Beside the fact that Kilgariff's *Chi-squared* method is much more precise than Mendenhall's *Characteristic Curves of Composition*, it is still a precarious method because words that appear very frequently tend to disfigure the output because of the disproportionate amount of weight they carry.
